...
function e(e2, t2) {
  var o2 = {};
  for (var n2 in e2)
    Object.prototype.hasOwnProperty.call(e2, n2) && t2.indexOf(n2) < 0 && (o2[n2] = e2[n2]);
  if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
    var i2 = 0;
    for (n2 = Object.getOwnPropertySymbols(e2); i2 < n2.length; i2++)
      t2.indexOf(n2[i2]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, n2[i2]) && (o2[n2[i2]] = e2[n2[i2]]);
  }
  return o2;
}
    ...
    function a3(r4) {
      return function(a4) {
        return function(r5) {
          ...
          for (; s3; )
            try {
              if (o3 = 1, n3 && (i2 = 2 & r5[0] ? n3.return : r5[0] ? n3.throw || ((i2 = n3.return) && i2.call(n3), 0) : n3.next) && !(i2 = i2.call(n3, r5[1])).done)
                return i2;
...
function P(e2) {
  if ("number" != typeof e2.modulusLength || e2.modulusLength < 2048)
    throw new C(`${e2.name} modulusLength must be at least 2048 bits`);
}
async function O(e2, t2, o2) {
  if (false === o2.usages.includes("sign"))
...
if (Uint8Array.prototype.toBase64)
  j = (e2) => (e2 instanceof ArrayBuffer && (e2 = new Uint8Array(e2)), e2.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e2 = 32768;
  j = (t2) => {
    t2 instanceof ArrayBuffer && (t2 = new Uint8Array(t2));
    const o2 = [];
    for (let n2 = 0; n2 < t2.byteLength; n2 += e2)
      o2.push(String.fromCharCode.apply(null, t2.subarray(n2, n2 + e2)));
...
async function V(t2, o2, n2, i2, r2, s2, a2, c2, h2, d2) {
  ...
  if (h2 && (I2 = v2["dpop-nonce"], I2 && await h2.setNonce(I2)), !_2) {
    ...
    if ("mfa_required" === w2)
      throw new m(w2, e2, k2.mfa_token);
    if ("missing_refresh_token" === w2)
      throw new f(n2, i2);
...
var B = class {
  ...
  async get(e2, t2 = 0, o2 = false, n2) {
    ...
    if (!r2) {
      ...
      if (i3 && (r2 = await this.cache.get(i3)), !i3 && o2 && "cache-only" !== n2)
  ...
  async getEntryWithRefreshToken(e2, t2) {
    ...
    for (const n2 of t2) {
      ...
      if ("@@auth0spajs@@" === t3.prefix && t3.clientId === e2.clientId) {
        ...
        if (null === (o2 = null == t4 ? void 0 : t4.body) || void 0 === o2 ? void 0 : o2.refresh_token)
...
var te = (e2) => {
  ...
  if (e2.max_age && !Q(t2.claims.auth_time))
    throw new Error("Authentication Time (auth_time) claim must be a number present in the ID token when Max Age (max_age) is specified");
  if (null == t2.claims.exp || !Q(t2.claims.exp))
    throw new Error("Expiration Time (exp) claim must be a number present in the ID token");
  if (!Q(t2.claims.iat))
    throw new Error("Issued At (iat) claim must be a number present in the ID token");
  const o2 = e2.leeway || 60, n2 = new Date(e2.now || Date.now()), i2 = /* @__PURE__ */ new Date(0);
  if (i2.setUTCSeconds(t2.claims.exp + o2), n2 > i2)
    throw new Error(`Expiration Time (exp) claim error in the ID token; current time (${n2}) is after expiration time (${i2})`);
  if (null != t2.claims.nbf && Q(t2.claims.nbf)) {
    const e3 = /* @__PURE__ */ new Date(0);
    if (e3.setUTCSeconds(t2.claims.nbf - o2), n2 < e3)
      throw new Error(`Not Before time (nbf) claim in the ID token indicates that this token can't be used just yet. Current time (${n2}) is before ${e3}`);
  }
  if (null != t2.claims.auth_time && Q(t2.claims.auth_time)) {
    const i3 = /* @__PURE__ */ new Date(0);
    if (i3.setUTCSeconds(parseInt(t2.claims.auth_time) + e2.max_age + o2), n2 > i3)
      throw new Error(`Authentication Time (auth_time) claim in the ID token indicates that too much time has passed since the last end-user authentication. Current time (${n2}) is after last auth at ${i3}`);
  }
  if (e2.organization) {
...
var oe = n(function(e2, o2) {
  var n2 = t && t.__assign || function() {
    return n2 = Object.assign || function(e3) {
      for (var t2, o3 = 1, n3 = arguments.length; o3 < n3; o3++)
        for (var i3 in t2 = arguments[o3])
...
function ue(e2, t2, o2) {
  var n2 = void 0 === t2 ? null : t2, i2 = function(e3, t3) {
    var o3 = atob(e3);
    if (t3) {
      for (var n3 = new Uint8Array(o3.length), i3 = 0, r3 = o3.length; i3 < r3; ++i3)
        n3[i3] = o3.charCodeAt(i3);
...
var Se = class {
  ...
  async handleResponse(e2, t2) {
    ...
    if (o2 && await this.hooks.setDpopNonce(o2), !this.hasUseDpopNonceError(e2))
      return e2;
    if (!o2 || !t2.onUseDpopNonceError)
      throw new g(o2);
...
var Pe = class {
  constructor(e2) {
    ...
    if (this.userCache = new $().enclosedCache, this.defaultOptions = { authorizationParams: { scope: "openid profile email" }, useRefreshTokensFallback: false, useFormData: true }, this._releaseLockOnPageHide = async () => {
      ...
      if (t2 = e2.cacheLocation || "memory", !we(t2))
    ...
    const i2 = await ((e3) => new Promise((t3, o3) => {
      ...
      n3 = function(s2) {
        if (s2.data && "authorization_response" === s2.data.type) {
          if (clearTimeout(r3), clearInterval(i3), window.removeEventListener("message", n3, false), e3.popup.close(), s2.data.response.error)
            return o3(u.fromPayload(s2.data.response));
          t3(s2.data.response);
        }
  ...
  async handleRedirectCallback(e2 = window.location.href) {
    ...
    if (this.transactionManager.remove(), i2)
      throw new h(i2, r2 || i2, o2, s2.appState);
    if (!s2.code_verifier || s2.state && s2.state !== o2)
      throw new u("state_mismatch", "Invalid state");
      ...
      if (!await (async (e2, t3 = 3) => {
        for (let o3 = 0; o3 < t3; o3++)
          if (await e2())
            return true;
        return false;
      })(() => Te.acquireLock("auth0.lock.getTokenSilently", 5e3), 10))
        throw new d();
      try {
  ...
  createFetcher(e2 = {}) {
    if (this.options.useDpop && !e2.dpopNonceId)
